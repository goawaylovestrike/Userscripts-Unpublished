...
(() => {
	...
	var __webpack_modules__ = {
		...
		432: (
			...
			var _node_modules_style_loader_dist_runtime_styleDomAPI_js__WEBPACK_IMPORTED_MODULE_1__ =
				__webpack_require__(825);
			var _node_modules_style_loader_dist_runtime_styleDomAPI_js__WEBPACK_IMPORTED_MODULE_1___default =
				__webpack_require__.n(
					_node_modules_style_loader_dist_runtime_styleDomAPI_js__WEBPACK_IMPORTED_MODULE_1__
				);
			var _node_modules_style_loader_dist_runtime_insertBySelector_js__WEBPACK_IMPORTED_MODULE_2__ =
				__webpack_require__(659);
			var _node_modules_style_loader_dist_runtime_insertBySelector_js__WEBPACK_IMPORTED_MODULE_2___default =
				__webpack_require__.n(
					_node_modules_style_loader_dist_runtime_insertBySelector_js__WEBPACK_IMPORTED_MODULE_2__
				);
			var _node_modules_style_loader_dist_runtime_setAttributesWithoutAttributes_js__WEBPACK_IMPORTED_MODULE_3__ =
				__webpack_require__(56);
			var _node_modules_style_loader_dist_runtime_setAttributesWithoutAttributes_js__WEBPACK_IMPORTED_MODULE_3___default =
				__webpack_require__.n(
					_node_modules_style_loader_dist_runtime_setAttributesWithoutAttributes_js__WEBPACK_IMPORTED_MODULE_3__
				);
			var _node_modules_style_loader_dist_runtime_insertStyleElement_js__WEBPACK_IMPORTED_MODULE_4__ =
				__webpack_require__(540);
			var _node_modules_style_loader_dist_runtime_insertStyleElement_js__WEBPACK_IMPORTED_MODULE_4___default =
				__webpack_require__.n(
					_node_modules_style_loader_dist_runtime_insertStyleElement_js__WEBPACK_IMPORTED_MODULE_4__
				);
			var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ =
				__webpack_require__(113);
			var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default =
				__webpack_require__.n(
					_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__
				);
			var _node_modules_css_loader_dist_cjs_js_node_modules_cssimportant_loader_index_js_node_modules_sass_loader_dist_cjs_js_main_scss__WEBPACK_IMPORTED_MODULE_6__ =
			...
			var update =
				_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(
					_node_modules_css_loader_dist_cjs_js_node_modules_cssimportant_loader_index_js_node_modules_sass_loader_dist_cjs_js_main_scss__WEBPACK_IMPORTED_MODULE_6__.A,
					options
				);
			var __WEBPACK_DEFAULT_EXPORT__ =
				_node_modules_css_loader_dist_cjs_js_node_modules_cssimportant_loader_index_js_node_modules_sass_loader_dist_cjs_js_main_scss__WEBPACK_IMPORTED_MODULE_6__.A &&
				_node_modules_css_loader_dist_cjs_js_node_modules_cssimportant_loader_index_js_node_modules_sass_loader_dist_cjs_js_main_scss__WEBPACK_IMPORTED_MODULE_6__
					.A.locals
					? _node_modules_css_loader_dist_cjs_js_node_modules_cssimportant_loader_index_js_node_modules_sass_loader_dist_cjs_js_main_scss__WEBPACK_IMPORTED_MODULE_6__
							.A.locals
					: void 0;
			...
			__webpack_require__.a(
				...
				async (
					...
					try {
						...
						var _tooltip_tooltip__WEBPACK_IMPORTED_MODULE_0__ =
							__webpack_require__(219);
						var _settings_endpoints__WEBPACK_IMPORTED_MODULE_1__ =
							__webpack_require__(378);
						var _utils__WEBPACK_IMPORTED_MODULE_2__ =
							__webpack_require__(185);
						var _dataTypes__WEBPACK_IMPORTED_MODULE_3__ =
							__webpack_require__(389);
						var _request__WEBPACK_IMPORTED_MODULE_4__ =
							__webpack_require__(463);
						var _settings_general__WEBPACK_IMPORTED_MODULE_5__ =
							__webpack_require__(44);
						var _observer__WEBPACK_IMPORTED_MODULE_6__ =
							__webpack_require__(648);
						var __webpack_async_dependencies__ =
							__webpack_handle_async_dependencies__([
								_tooltip_tooltip__WEBPACK_IMPORTED_MODULE_0__,
								_settings_endpoints__WEBPACK_IMPORTED_MODULE_1__,
								_settings_general__WEBPACK_IMPORTED_MODULE_5__,
							]);
						[
							_tooltip_tooltip__WEBPACK_IMPORTED_MODULE_0__,
							_settings_endpoints__WEBPACK_IMPORTED_MODULE_1__,
						...
						const supportedDataFields = new Map([
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_3__.We
									.Scene,
								[
									_dataTypes__WEBPACK_IMPORTED_MODULE_3__.J7
										.Id,
									_dataTypes__WEBPACK_IMPORTED_MODULE_3__.J7
										.Title,
									_dataTypes__WEBPACK_IMPORTED_MODULE_3__.J7
							...
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_3__.We.Tag,
								[
									_dataTypes__WEBPACK_IMPORTED_MODULE_3__.J7
										.Id,
									_dataTypes__WEBPACK_IMPORTED_MODULE_3__.J7
						...
						const supportedSubDataFields = new Map([
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_3__.J7
									.Studio,
								[
							...
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_3__.J7.Tags,
								[
									_dataTypes__WEBPACK_IMPORTED_MODULE_3__.J7
										.Id,
									_dataTypes__WEBPACK_IMPORTED_MODULE_3__.J7
						...
						function getDataFields(target) {
							let supported = new Set(
								supportedDataFields.get(target) ?? []
							);
							if (
								!_settings_general__WEBPACK_IMPORTED_MODULE_5__.$k.get(
									_settings_general__WEBPACK_IMPORTED_MODULE_5__
										.vw.showTags
								)
							)
							...
							return Array.from(supported)
								.map((field) => field + getSubDataFields(field))
								.join(",");
						}
						function getSubDataFields(field) {
							let supported =
								supportedSubDataFields.get(field) ?? [];
						...
						async function queryStash(
							...
							switch (type) {
								case _dataTypes__WEBPACK_IMPORTED_MODULE_3__.ZU
									.StashId:
									criterion = `stash_id_endpoint:{endpoint:"${encodeURIComponent(
										stashIdEndpoint
									)}",stash_id:"${encodeURIComponent(
										queryString
									)}",modifier:EQUALS}`;
									break;
							...
							switch (target) {
								case _dataTypes__WEBPACK_IMPORTED_MODULE_3__.We
									.Scene:
									query = `findScenes(scene_filter:{${criterion}}){scenes{${getDataFields(
										target
									)}}}`;
									access = (d) => d.scenes;
									break;
								...
								case _dataTypes__WEBPACK_IMPORTED_MODULE_3__.We
									.Performer:
									query = `findPerformers(performer_filter:{${criterion}}){performers{${getDataFields(
										target
									)}}}`;
								...
								case _dataTypes__WEBPACK_IMPORTED_MODULE_3__.We
									.Gallery:
									query = `findGalleries(gallery_filter:{${criterion}}){galleries{${getDataFields(
										target
									)}}}`;
								...
								case _dataTypes__WEBPACK_IMPORTED_MODULE_3__.We
									.Movie:
									query = `findMovies(movie_filter:{${criterion}}){movies{${getDataFields(
										target
									)}}}`;
									access = (d) => d.movies;
									break;
								...
								case _dataTypes__WEBPACK_IMPORTED_MODULE_3__.We
									.Studio:
									query = `findStudios(studio_filter:{${criterion}}){studios{${getDataFields(
										target
									)}}}`;
									access = (d) => d.studios;
									break;
								...
								case _dataTypes__WEBPACK_IMPORTED_MODULE_3__.We
									.Tag:
									query = `findTags(tag_filter:{${criterion}}){tags{${getDataFields(
										target
									)}}}`;
									access = (d) => d.tags;
									break;
							...
							_settings_endpoints__WEBPACK_IMPORTED_MODULE_1__.I.forEach(
								(endpoint) => {
									(0,
									_request__WEBPACK_IMPORTED_MODULE_4__.E)(
										endpoint,
										query,
										true
									).then((data) =>
							...
							if (urlSelector && prepareUrl) {
								...
								if (url) {
									...
									await queryStash(
										...
										(...args) =>
											(0,
											_tooltip_tooltip__WEBPACK_IMPORTED_MODULE_0__.l)(
												displayElement,
												...args,
												color
											),
						...
						function check(
							target,
							elementSelector,
							{ observe = false, ...checkConfig } = {}
						) {
							if (observe)
								(0, _observer__WEBPACK_IMPORTED_MODULE_6__.C)(
									elementSelector,
									(element) =>
										checkElement(
											target,
							...
							document
								...
								.forEach((e) =>
									checkElement(target, e, checkConfig)
								);
						}
						__webpack_async_result__();
					} catch (e) {
		...
		156: (
			...
			__webpack_require__.a(
				...
				async (
					...
					try {
						var _style_main_scss__WEBPACK_IMPORTED_MODULE_0__ =
							__webpack_require__(432);
						var _settings_endpoints__WEBPACK_IMPORTED_MODULE_1__ =
							__webpack_require__(378);
						var _tooltip_tooltipElement__WEBPACK_IMPORTED_MODULE_7__ =
							__webpack_require__(563);
						var _settings_settings__WEBPACK_IMPORTED_MODULE_2__ =
							__webpack_require__(59);
						var _settings_menu__WEBPACK_IMPORTED_MODULE_3__ =
							__webpack_require__(513);
						var _settings_general__WEBPACK_IMPORTED_MODULE_4__ =
							__webpack_require__(44);
						var _stashChecker__WEBPACK_IMPORTED_MODULE_5__ =
							__webpack_require__(782);
						var _settings_statistics__WEBPACK_IMPORTED_MODULE_6__ =
							__webpack_require__(821);
						var __webpack_async_dependencies__ =
							__webpack_handle_async_dependencies__([
								_settings_endpoints__WEBPACK_IMPORTED_MODULE_1__,
								_settings_settings__WEBPACK_IMPORTED_MODULE_2__,
								_settings_menu__WEBPACK_IMPORTED_MODULE_3__,
								_settings_general__WEBPACK_IMPORTED_MODULE_4__,
								_stashChecker__WEBPACK_IMPORTED_MODULE_5__,
								_settings_statistics__WEBPACK_IMPORTED_MODULE_6__,
							]);
						[
							_settings_endpoints__WEBPACK_IMPORTED_MODULE_1__,
							_settings_settings__WEBPACK_IMPORTED_MODULE_2__,
						...
						(async function () {
							await (0,
							_tooltip_tooltipElement__WEBPACK_IMPORTED_MODULE_7__.AA)();
							(0,
							_settings_settings__WEBPACK_IMPORTED_MODULE_2__.yD)();
							(0,
							_settings_statistics__WEBPACK_IMPORTED_MODULE_6__.S)();
							(0,
							_settings_general__WEBPACK_IMPORTED_MODULE_4__.WA)();
							await (0,
							_settings_endpoints__WEBPACK_IMPORTED_MODULE_1__.P)();
							await (0,
							_settings_menu__WEBPACK_IMPORTED_MODULE_3__.Q)();
				...
				let observer = new MutationObserver((mutations) => {
					...
					addedElements
						...
						.filter(
							(e) =>
								!e.matches(exclude) &&
								!e.parentElement?.matches(exclude)
						)
						.forEach(callback);
				});
		...
		463: (
						...
						job.job()
							...
							.finally(() => {
								...
								this.queue = this.queue.filter(
									(job) => job.status !== Status.FINISHED
								);
								void 0;
								this.dequeue();
							});
			...
			async function request(endpoint, query, batchQueries = false) {
				if (batchQueries) return addQuery(endpoint, query);
				else
					return new Promise((resolve, reject) =>
						sendQuery(endpoint, `q:${query}`)
							.then((data) => resolve(data.q))
							.catch(reject)
					);
			}
					...
					if (!batchQuery) {
						let timerHandle = window.setTimeout(() => {
							let query = buildBatchQuery(
								endpoint,
								batchQueries.get(endpoint)
							);
							batchQueue
								.enqueue(() => sendQuery(endpoint, query.query))
								.then(query.resolve)
								.catch(query.reject);
			...
			function buildBatchQuery(endpoint, batchQuery) {
				...
				console.info(
					`Build batch query of size ${batchQuery.queries.length} for endpoint '${endpoint.name}'`
				);
				return {
					query,
					resolve,
								...
								case 200:
									try {
										...
										if ("errors" in r)
											r.errors.forEach((e) => {
												console.error(
													`Stash returned "${e.extensions.code}" error: ${e.message}`
												);
												reject(e.message);
											});
										else resolve(r.data);
			...
			function statusMessage(status, statusText) {
				...
				else return `${status}: ${utils.iy.get(status)}`;
			}
		},
			...
			__webpack_require__.a(
				...
				async (
					...
					try {
						...
						var _storage__WEBPACK_IMPORTED_MODULE_0__ =
							__webpack_require__(613);
						var _request__WEBPACK_IMPORTED_MODULE_1__ =
							__webpack_require__(463);
						var _settings__WEBPACK_IMPORTED_MODULE_2__ =
							__webpack_require__(59);
						var __webpack_async_dependencies__ =
							__webpack_handle_async_dependencies__([
						...
						const stashEndpoints = await (0,
						_storage__WEBPACK_IMPORTED_MODULE_0__._W)(
							_storage__WEBPACK_IMPORTED_MODULE_0__.Zg
								.StashEndpoints,
							defaultData
						);
						async function initEndpointSettings() {
							let description =
								"The GraphQL endpoint URL can be generated by appending '/graphql' to your Stash base URL. The API key can be found on your security settings page. Leave the field empty, if none is required.";
							let endpointSection = (0,
							_settings__WEBPACK_IMPORTED_MODULE_2__.Lc)(
								"endpoints",
								"Stash Endpoints",
								description
							);
						...
						async function updateEndpoints(container) {
							let endpointList = stashEndpoints.map(
								(endpoint, index) => {
									...
									let editButton = (0,
									_settings__WEBPACK_IMPORTED_MODULE_2__.jr)(
										"Edit",
										editEndpointListener
									);
									...
									let deleteButton = (0,
									_settings__WEBPACK_IMPORTED_MODULE_2__.g8)(
										"Delete",
										deleteEndpointListener
									);
							...
							div.append(
								(0, _settings__WEBPACK_IMPORTED_MODULE_2__.jr)(
									"Add",
									addEndpointListener
								)
							);
						...
						async function addEndpointListener() {
							...
							void (0, _storage__WEBPACK_IMPORTED_MODULE_0__.KY)(
								_storage__WEBPACK_IMPORTED_MODULE_0__.Zg
									.StashEndpoints,
								stashEndpoints
							);
							await updateEndpoints(
								(0, _settings__WEBPACK_IMPORTED_MODULE_2__.zH)(
									"endpoints"
								)
							);
						}
						async function editEndpointListener() {
							...
							stashEndpoints[index] = {
								name:
									prompt("Name:", oldEndpoint.name)?.trim() ??
									oldEndpoint.name,
								url:
									prompt("URL:", oldEndpoint.url)?.trim() ??
									oldEndpoint.url,
								key:
									prompt(
										"API Key:",
										oldEndpoint.key
									)?.trim() ?? oldEndpoint.key,
							};
							void (0, _storage__WEBPACK_IMPORTED_MODULE_0__.KY)(
								_storage__WEBPACK_IMPORTED_MODULE_0__.Zg
									.StashEndpoints,
						...
						async function getVersion(endpoint, element) {
							...
							await (0, _request__WEBPACK_IMPORTED_MODULE_1__.E)(
								endpoint,
								"version{version}"
							)
								.then(resolve)
			...
			__webpack_require__.a(
				...
				async (
					...
					try {
						...
						var _settings__WEBPACK_IMPORTED_MODULE_0__ =
							__webpack_require__(59);
						var _storage__WEBPACK_IMPORTED_MODULE_1__ =
							__webpack_require__(613);
						var __webpack_async_dependencies__ =
							__webpack_handle_async_dependencies__([
						...
						_storage__WEBPACK_IMPORTED_MODULE_1__._W)(
							_storage__WEBPACK_IMPORTED_MODULE_1__.Zg
								.BooleanOptions,
							defaultBooleanOptions
						);
						const stringOptions = await (0,
						_storage__WEBPACK_IMPORTED_MODULE_1__._W)(
							_storage__WEBPACK_IMPORTED_MODULE_1__.Zg
								.StringOptions,
						...
						function initGeneralSettings() {
							let generalSection = (0,
							_settings__WEBPACK_IMPORTED_MODULE_0__.Lc)(
								"general",
								"General"
							);
						...
						function populateGeneralSection(generalSection) {
							let symbolSettings = fieldSet(
								"symbol-settings",
								"Symbol"
							);
							symbolSettings.append(
								checkBox(
									OptionKey.showCrossMark,
									"Show cross mark"
								),
							...
							div.appendChild(
								(0, _settings__WEBPACK_IMPORTED_MODULE_0__.g8)(
									"Reset",
									resetToDefault
								)
							);
						...
						function resetToDefault() {
							defaultBooleanOptions.forEach((value, key) =>
								booleanOptions.set(key, value)
							);
							void (0, _storage__WEBPACK_IMPORTED_MODULE_1__.KY)(
								_storage__WEBPACK_IMPORTED_MODULE_1__.Zg
									.BooleanOptions,
								booleanOptions
							);
							defaultStringOptions.forEach((value, key) =>
								stringOptions.set(key, value)
							);
							void (0, _storage__WEBPACK_IMPORTED_MODULE_1__.KY)(
								_storage__WEBPACK_IMPORTED_MODULE_1__.Zg
									.StringOptions,
							...
							let generalSection = (0,
							_settings__WEBPACK_IMPORTED_MODULE_0__.zH)(
								"general"
							);
							populateGeneralSection(generalSection);
						}
						function checkBox(key, label) {
							...
							inputElement.defaultChecked =
								booleanOptions.get(key) ?? false;
							inputElement.addEventListener("input", () => {
								booleanOptions.set(key, inputElement.checked);
								void (0,
								_storage__WEBPACK_IMPORTED_MODULE_1__.KY)(
									_storage__WEBPACK_IMPORTED_MODULE_1__.Zg
										.BooleanOptions,
									booleanOptions
								);
			...
			__webpack_require__.a(
				...
				async (
					...
					try {
						...
						const BLOCKED_SITE_KEY =
							`blocked_${window.location.host}`.replace(
								/[.\-]/,
								"_"
							);
						async function initMenu() {
							GM.registerMenuCommand(
								"Settings",
								_settings__WEBPACK_IMPORTED_MODULE_0__.YH,
								"s"
							);
							if (await isSiteBlocked())
								GM.registerMenuCommand(
									`Activate for ${window.location.host}`,
									unblockSite,
									"a"
								);
							else
								GM.registerMenuCommand(
									`Deactivate for ${window.location.host}`,
									blockSite,
									"d"
								);
						}
						...
						async function blockSite() {
							await (0, _storage__WEBPACK_IMPORTED_MODULE_1__.KY)(
								BLOCKED_SITE_KEY,
								true
							);
						...
						async function unblockSite() {
							await (0, _storage__WEBPACK_IMPORTED_MODULE_1__.Tc)(
								BLOCKED_SITE_KEY
							);
							window.location.reload();
						}
			...
			__webpack_require__.a(
				...
				async (
					...
					try {
						...
						var _observer__WEBPACK_IMPORTED_MODULE_3__ =
							__webpack_require__(648);
						var _tooltip_tooltip__WEBPACK_IMPORTED_MODULE_0__ =
							__webpack_require__(219);
						var _stashChecker__WEBPACK_IMPORTED_MODULE_1__ =
							__webpack_require__(782);
						var _statistics__WEBPACK_IMPORTED_MODULE_2__ =
							__webpack_require__(821);
						var __webpack_async_dependencies__ =
							__webpack_handle_async_dependencies__([
								_tooltip_tooltip__WEBPACK_IMPORTED_MODULE_0__,
								_stashChecker__WEBPACK_IMPORTED_MODULE_1__,
								_statistics__WEBPACK_IMPORTED_MODULE_2__,
							]);
						[
							_tooltip_tooltip__WEBPACK_IMPORTED_MODULE_0__,
							_stashChecker__WEBPACK_IMPORTED_MODULE_1__,
						...
						function closeSettingsWindow(event) {
							if (event.target === this) {
								...
								(0,
								_tooltip_tooltip__WEBPACK_IMPORTED_MODULE_0__.T)();
								(0,
								_stashChecker__WEBPACK_IMPORTED_MODULE_1__.C)();
							}
						}
			...
			__webpack_require__.a(
				...
				async (
					...
					try {
						...
						var _dataTypes__WEBPACK_IMPORTED_MODULE_0__ =
							__webpack_require__(389);
						var _settings__WEBPACK_IMPORTED_MODULE_1__ =
							__webpack_require__(59);
						var __webpack_async_dependencies__ =
							__webpack_handle_async_dependencies__([
						...
						function initStatistics() {
							(0, _settings__WEBPACK_IMPORTED_MODULE_1__.Lc)(
								"statistics",
								"Statistics"
							);
						}
						function updateStatistics() {
							let statisticsSection = (0,
							_settings__WEBPACK_IMPORTED_MODULE_1__.zH)(
								"statistics"
							);
							let targets = [
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.We
									.Scene,
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.We
									.Movie,
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.We
								...
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.We
									.Studio,
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.We.Tag,
							];
							let string = targets
								.flatMap((target) => {
						...
						function statistics(target) {
							...
							let string = `Matched ${symbolCount(target, [
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.Wb
									.Check,
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.Wb
									.Warning,
							])} out of ${count} ${(0,
							_dataTypes__WEBPACK_IMPORTED_MODULE_0__.T4)(
								target
							)}`;
						...
						function symbolCount(target = void 0, symbol = void 0) {
							...
							if (symbol)
								symbols = symbols.filter((element) =>
									symbol
										.map((s) => s.toString())
										.includes(
		...
		613: (
			...
			async function getValue(key, defaultValue) {
				...
				try {
					if (text === void 0) return Promise.resolve(defaultValue);
					else return Promise.resolve(JSON.parse(text, reviver));
				} catch (e) {
					console.warn(
						"Failed to parse stored value. Delete stored key-value pair."
					);
			...
			__webpack_require__.a(
				...
				async (
					...
					try {
						...
						var _check__WEBPACK_IMPORTED_MODULE_0__ =
							__webpack_require__(464);
						var _dataTypes__WEBPACK_IMPORTED_MODULE_1__ =
							__webpack_require__(389);
						var _utils__WEBPACK_IMPORTED_MODULE_2__ =
							__webpack_require__(185);
						var _settings_menu__WEBPACK_IMPORTED_MODULE_3__ =
						...
						var __webpack_async_dependencies__ =
							__webpack_handle_async_dependencies__([
								_check__WEBPACK_IMPORTED_MODULE_0__,
								_settings_menu__WEBPACK_IMPORTED_MODULE_3__,
							]);
						[
							_check__WEBPACK_IMPORTED_MODULE_0__,
						...
						async function runStashChecker() {
							if (
								await (0,
								_settings_menu__WEBPACK_IMPORTED_MODULE_3__.e)()
							) {
								console.info(
									"Userscript is deactivated for this site. Activate in userscript menu."
								);
								return;
							}
							...
							switch (window.location.host) {
										...
										"#avidolDetails",
										{
											...
											nameSelector: (e) =>
												e
													...
													?.getAttribute("alt") ??
												(0,
												_utils__WEBPACK_IMPORTED_MODULE_2__.ou)(
													e
												),
										}
									);
								...
								case "javdb.com":
										...
										".video-detail > h2",
										{
											...
											codeSelector: (_) => {
												let xpath = document.evaluate(
													"//div/strong[text()='ID:']/following-sibling::span[1]//text()",
													document,
													null,
									...
									if (
										...
										_check__WEBPACK_IMPORTED_MODULE_0__.z)(
											_dataTypes__WEBPACK_IMPORTED_MODULE_1__
												.We.Scene,
											"a[href^='/v/'] > .video-number",
											{
												titleSelector: (e) =>
													e.parentElement?.title?.trim(),
												codeSelector: (e) =>
													e.textContent?.trim(),
											}
										);
								...
								case "theporndb.net": {
									let stashIdSelector = (_) =>
										document
											.querySelector(
												"div[name='UUID'] > div > div.flex"
											)
											?.textContent?.trim();
									let stashIdEndpoint =
									...
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Performer,
										"a[href^='https://theporndb.net/performers/']",
										{
											observe: true,
										}
									);
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Scene,
										"a[href^='https://theporndb.net/scenes/'], a[href^='https://theporndb.net/jav/']",
										{
											observe: true,
										}
									);
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Movie,
										"a[href^='https://theporndb.net/movies/']",
										{
											observe: true,
										}
									);
								...
								case "www.javlibrary.com":
									...
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Scene,
										".comment strong > a[href^='videoreviews.php?v=jav']",
										{
											prepareUrl: (url) =>
												url
													.replace(
								...
								case "r18.dev":
									...
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Scene,
										".video-label > a[href*='/movies/detail/']",
										{
											observe: true,
											codeSelector:
												_utils__WEBPACK_IMPORTED_MODULE_2__.ou,
								...
								case "manyvids.com":
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Scene,
										".VideoCardUI_videoTitle__x8MuF a",
										{
											observe: true,
											titleSelector: (e) =>
												e.title || e.innerText,
									...
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Scene,
										"h1.VideoMetaInfo_title__mWRak",
										{
											observe: true,
											titleSelector: (e) => e.innerText,
											urlSelector: () => location.href,
										}
									);
									break;

								case "www.fullporn.xxx":
								case "fullporn.xxx":
								case "www.omg.xxx":
									setTimeout(() => {
										(0,
								...
								case "www.indexxx.com":
									...
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Performer,
										"a.modelLink[href^='https://www.indexxx.com/m/'] > span"
									);
									break;
								...
								case "www.thenude.com":
									...
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Performer,
										"a.model-name, a.model-title, a[data-img*='/models/']",
										{
											observe: true,
										}
									);
								...
								case "www.data18.com": {
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Scene,
										"a[href^='https://www.data18.com/scenes/']:not([href*='#'])",
										{
											observe: true,
											titleSelector: (e) =>
									...
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Movie,
										"a[href^='https://www.data18.com/movies/']:not([href*='#']):not([href$='/movies/series']):not([href$='/movies/showcases'])",
										{
											observe: true,
											nameSelector: (e) =>
												e.getAttribute("title")?.trim(),
									...
									let exclude =
										":not([href*='/pairings']):not([href*='/studio']):not([href*='/virtual-reality']):not([href*='/scenes']):not([href*='/movies']):not([href*='/tags']):not([title$=' Home'])";
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Performer,
										`a[href^='https://www.data18.com/name/']${exclude}`,
										{
											observe: true,
										}
									);
								...
								case "www.freeones.com":
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Performer,
										"a[href$='/feed'] [data-test='subject-name'], a[href$='/feed'] .profile-image + p",
										{
											prepareUrl: (url) =>
												url
													.replace(/\/feed$/, "")
								...
								case "onlyfans.com":
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Performer,
										"div.b-username > div.g-user-name",
										{
											observe: true,
											urlSelector: currentSite,
										}
								...
								case "pmvhaven.com":
									...
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Studio,
										"a[href^='/creator/'] .v-chip__content",
										{
											observe: true,
										}
									);
								...
								case "stashdb.org": {
									let exclude =
										":not(a[href$='/add']):not(a[href$='/edit']):not(a[href$='/merge']):not(a[href$='/delete'])";
									let stashBoxDefault = {
										observe: true,
										urlSelector: null,
										titleSelector: null,
									...
									function findId(string) {
										return string?.match(
											/\p{Hex}{8}-\p{Hex}{4}-\p{Hex}{4}-\p{Hex}{4}-\p{Hex}{12}/u
										)?.[0];
									}
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Scene,
										"div.scene-info.card h3 > span",
										{
											...stashBoxDefault,
											stashIdSelector: () =>
												findId(window.location.href),
										}
									);
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Scene,
										`a[href^='/scenes/']${exclude}, a[href^='https://${window.location.host}/scenes/']${exclude}`,
										{
											...stashBoxDefault,
											stashIdSelector: (e) =>
												findId(e.closest("a")?.href),
										}
									);
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Performer,
										"div.PerformerInfo div.card-header h3 > span",
										{
											...stashBoxDefault,
											stashIdSelector: () =>
												findId(window.location.href),
									...
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Performer,
										`a[href^='/performers/']${exclude}, a[href^='https://${window.location.host}/performers/']${exclude}`,
										{
											...stashBoxDefault,
											stashIdSelector: (e) =>
												findId(e.closest("a")?.href),
									...
									(0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(
										_dataTypes__WEBPACK_IMPORTED_MODULE_1__
											.We.Studio,
										`a[href^='/studios/']${exclude}, a[href^='https://${window.location.host}/studios/']${exclude}`,
										{
											...stashBoxDefault,
											stashIdSelector: (e) =>
												findId(e.closest("a")?.href),
								...
								default:
									console.warn(
										"No configuration for website found."
									);
									break;
							}
						}
		...
		657: (
			...
			class StashQueryClass {
				...
				toHtml(target, id, numQueries) {
					let typesString = `(Matched: ${this.types
						.map((type) =>
							_utils__WEBPACK_IMPORTED_MODULE_0__.xG.get(type)
						)
						.join(", ")})`;
					return `${this.matchQualityHtml(numQueries)} ${
						this.endpoint
					} ${typesString}: ${(0,
					_utils__WEBPACK_IMPORTED_MODULE_0__.bM)(
						this.baseUrl,
						target,
						id
					)}`;
			...
			__webpack_require__.a(
				...
				async (
					...
					try {
						...
						var _dataTypes__WEBPACK_IMPORTED_MODULE_0__ =
							__webpack_require__(389);
						var _utils__WEBPACK_IMPORTED_MODULE_1__ =
							__webpack_require__(185);
						var _settings_general__WEBPACK_IMPORTED_MODULE_2__ =
							__webpack_require__(44);
						var _stashQuery__WEBPACK_IMPORTED_MODULE_3__ =
							__webpack_require__(657);
						var _tooltipElement__WEBPACK_IMPORTED_MODULE_4__ =
							__webpack_require__(563);
						var __webpack_async_dependencies__ =
							__webpack_handle_async_dependencies__([
						...
						const propertyStrings = new Map([
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7
									.Aliases,
								(aliases) =>
									aliases.length === 0
										? ""
										: `<br>Aliases: ${aliases.join(
												", <wbr>"
										  )}`,
							],
							[
							...
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7
									.Birthdate,
								(birthdate) => `<br>Birthdate: ${birthdate}`,
							],
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7
									.BitRate,
							...
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7.Code,
								(code) => `<br>Code: ${code}`,
							],
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7.Date,
								(date) => `<br>Date: ${date}`,
							],
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7
									.Disambiguation,
								(disambiguation) =>
									` <span style="color: grey">(${disambiguation})</span>`,
							],
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7
									.Duration,
								(duration) =>
									`&nbsp;&nbsp;&nbsp;&nbsp;Duration: ${(0,
									_utils__WEBPACK_IMPORTED_MODULE_1__.xr)(
										duration
									)}`,
							],
							[
							...
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7
									.Files,
								(files, queries, target, numQueries) =>
									`${files
										.map((file) =>
											formatFileData(
												file,
							...
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7
									.HeightCm,
								(height) => `<br>Height: ${height} cm`,
							],
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7.Id,
								(id, queries, target, numQueries) =>
									`<br>${formatQueries(
										queries,
										target,
										id,
							...
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7.Name,
								(name) => `<br>Name: ${name}`,
							],
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7.Path,
								(path) => `Path: ${path}`,
							],
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7.Size,
								(size) =>
									`&nbsp;&nbsp;&nbsp;&nbsp;Size: ${(0,
									_utils__WEBPACK_IMPORTED_MODULE_1__.$R)(
										size
									)}`,
							],
							[
							...
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7.Tags,
								(tags) =>
									tags.length === 0
										? ""
										: `<br>Tags: ${tags
							...
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7
									.VideoCodec,
								(video_codec) => `<br>Codec: ${video_codec}`,
							],
							[
								_dataTypes__WEBPACK_IMPORTED_MODULE_0__.J7
									.Width,
						...
						function formatQueries(
							...
							return queries
								.map((query) =>
									new _stashQuery__WEBPACK_IMPORTED_MODULE_3__.M(
										query
									).toHtml(target, id, numQueries)
								)
								.join("<br>");
						...
						function mergeData(target, source) {
							let mapTarget = new Map(
								target.map((e) => [entryKey(e), e])
							);
							let mapSource = new Map(
								source.map((e) => [entryKey(e), e])
							);
							mapSource.forEach((sourceEntry, key) => {
								if (mapTarget.has(key)) {
									let sourceQueries = new Map(
										sourceEntry.queries.map((v) => [
											v.endpoint,
											v,
										])
									);
									let targetQueries = new Map(
										mapTarget
											.get(key)
											.queries.map((v) => [v.endpoint, v])
									);
									sourceQueries.forEach(
										(sourceQuery, key) => {
									...
									sourceEntry.queries = Array.from(
										targetQueries.values()
									)
										.map(
											(q) =>
												new _stashQuery__WEBPACK_IMPORTED_MODULE_3__.M(
						...
						function stashSymbol() {
							...
							symbol.addEventListener(
								"mouseover",
								_tooltipElement__WEBPACK_IMPORTED_MODULE_4__.sQ
							);
							symbol.addEventListener(
								"mouseout",
								_tooltipElement__WEBPACK_IMPORTED_MODULE_4__._I
							);
							return symbol;
						}
						function prefixSymbol(
							...
							if (symbol) {
								...
								queryTypes = [
									...new Set(
										JSON.parse(
											symbol.getAttribute("data-queries")
										)
									).add(type),
								].sort();
								data = mergeData(
									JSON.parse(
										symbol.getAttribute("data-data")
									),
									data
								);
								symbol.setAttribute(
									...
									(
										parseInt(
											symbol.getAttribute("data-count")
										) + 1
									).toString()
								);
							} else {
								symbol = stashSymbol();
								let text = (0,
								_utils__WEBPACK_IMPORTED_MODULE_1__.Yz)(
									element
								);
								if (text)
							...
							let tooltip = "";
							let targetReadable = (0,
							_dataTypes__WEBPACK_IMPORTED_MODULE_0__.HD)(target);
							if (count === 0) {
								symbol.setAttribute(
									"data-symbol",
									_dataTypes__WEBPACK_IMPORTED_MODULE_0__.Wb
								...
								if (
									_settings_general__WEBPACK_IMPORTED_MODULE_2__.$k.get(
										_settings_general__WEBPACK_IMPORTED_MODULE_2__
											.vw.showCrossMark
									)
								)
							...
							tooltip += "<br>";
							tooltip += `Queries: ${queryTypes
								.map((type) =>
									_utils__WEBPACK_IMPORTED_MODULE_1__.xG.get(
										type
									)
								)
								.join(", ")}`;
		...
		563: (
			...
			function mouseoverListener() {
				let tooltipWindow = document.getElementById(
					"stashChecker-tooltipWindow"
				);
				...
				if (north)
					tooltipWindow.style.top = `${Math.max(
						margin,
						symbolPos.top - tooltipWindow.clientHeight
					).toFixed(0)}px`;
				else
					tooltipWindow.style.top = `${Math.min(
						window.innerHeight -
							tooltipWindow.clientHeight -
							margin,
						symbolPos.top + symbolPos.height + margin
					).toFixed(0)}px`;
				tooltipWindow.style.left = `${Math.max(
					margin,
					Math.min(
						window.innerWidth - tooltipWindow.clientWidth - margin,
						symbolPos.left +
							symbolPos.width / 2 -
							tooltipWindow.clientWidth / 2
					)
				).toFixed(0)}px`;
			}
		...
		185: (
			...
			function firstTextChild(node) {
				...
				if (
					...
					return Array.from(node.childNodes)
						.filter(
							(n) => !["svg"].includes(n.nodeName.toLowerCase())
						)
						.filter((n) =>
							n.nodeType === Node.ELEMENT_NODE
								? n.getAttribute("data-type") !== "stash-symbol"
								: true
						)
						.map(firstTextChild)
						.find((n) => n);
			...
			function entryLink(stashUrl, target, id) {
				let path;
				if (target == "gallery") path = "galleries";
				else path = target + "s";
			...
			function interleave(array, between) {
				return array
					.flatMap((element) => [element, between.cloneNode(true)])
					.slice(0, -1);
			}
			let friendlyHttpStatus = new Map([
				[200, "OK"],
				[201, "Created"],
				[202, "Accepted"],
			...
			const typeToString = new Map([
				[_dataTypes__WEBPACK_IMPORTED_MODULE_0__.ZU.Url, "URL"],
				[_dataTypes__WEBPACK_IMPORTED_MODULE_0__.ZU.Code, "Code"],
				[_dataTypes__WEBPACK_IMPORTED_MODULE_0__.ZU.StashId, "StashId"],
				[_dataTypes__WEBPACK_IMPORTED_MODULE_0__.ZU.Name, "Name"],
				[_dataTypes__WEBPACK_IMPORTED_MODULE_0__.ZU.Title, "Title"],
			]);
		},
	};
...
function waitForTitles(retries = 30) {
	if (window._pornolabTitles && window._pornolabTitles.length > 0) {
		checkTitles(window._pornolabTitles);
	} else if (retries > 0) {
		setTimeout(() => waitForTitles(retries - 1), 500);
	} else {
		console.warn("[STASH] Gave up waiting for Pornolab titles.");
	}
}
